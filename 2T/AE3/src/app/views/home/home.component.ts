...
export class HomeComponent {
  ...
  /**
   * Displays the info of the type of memory selected.
   * @param {IKeyValue} selectedMemoryDetails
   * @returns {void}
   */
  public showDetailsImg(selectedMemoryDetails: IKeyValue): void {
    this.isDescriptionHomeHidden = true;
